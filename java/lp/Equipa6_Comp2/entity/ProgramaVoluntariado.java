...
public class ProgramaVoluntariado {
	...
	public void addInstituicoes(Instituicao inst) {
		instituicoes.add(inst);
        inst.setPrograma(this);
    }
	
	
	public TiposVoluntariado getTiposVoluntariado() {
		return tipoVoluntariado;
	}
	public void setTiposVoluntariado(TiposVoluntariado tipoVoluntariado) {
