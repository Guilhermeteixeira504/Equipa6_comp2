...
public class ProgramaVoluntariadoController {
	...
	public ProgramaVoluntariadoDTO create(@RequestBody ProgramaVoluntariadoDTO dto) {
		ProgramaVoluntariado programa = programaVoluntariadoService.createProgramaVoluntariado(dto.getTiposVoluntariadoId(), ProgramaVoluntariadoMapper.toEntity(dto));
