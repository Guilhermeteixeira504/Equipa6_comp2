...
public class UtilizadorService {
	...
	public UtilizadorService(UtilizadorRepository utilizadorRepository, VoluntarioRepository voluntarioRepository) {
	...
	public Utilizador createUtilizador(Utilizador u) {
        ...
        if ("voluntario".equalsIgnoreCase(u.getTipoUtilizador())) {
