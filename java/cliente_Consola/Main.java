...
public class Main {
	...
	private static void criarEdicao() {
        ...
        String json = """
        		...
        		""".formatted(ano,vagas,di,df,programaId);
    ...
    private static void definirHorasTrabalhadas() {
        ...
        String json = """
                ...
                """.formatted(programaId,voluntarioId,horas);
        ...
        try {
        	String response = rest.exchange(BASE_URL + "/voluntariado/inscricoes/" + inscricaoId,HttpMethod.PUT,request,String.class).getBody();
